# Generated by Django 4.2.4 on 2023-10-18 18:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alt_poc_number', phonenumber_field.modelfields.PhoneNumberField(max_length=128, region=None)),
        ...
        migrations.CreateModel(
            name='institutionalTeam_Contingent',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
